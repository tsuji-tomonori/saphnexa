...
export const apiImplementationCoverage = {
  ...
  cancelAnswerGeneration: api("aggregate", "aggregate", "aggregate", "aggregate", "implemented", { domainEvent: "implemented", unitTest: "aggregate", localIntegrationTest: "implemented", dsqlSmoke: "aggregate" }),
  createFeedback: api("aggregate", "aggregate", "aggregate", "aggregate", "implemented", { domainEvent: "implemented", unitTest: "aggregate", localIntegrationTest: "implemented", dsqlSmoke: "aggregate" }),
  ...
  retryIngestionJob: api("aggregate", "aggregate", "aggregate", "aggregate", "implemented", { domainEvent: "implemented", audit: "implemented", unitTest: "aggregate", localIntegrationTest: "implemented", dsqlSmoke: "aggregate" }),
