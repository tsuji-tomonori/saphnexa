...
export type ChatMessage = { message_id: string; parent_message_id?: string | null; sender_user_id?: string | null; sender_type: "general_user" | "admin" | "assistant"; content_text: string; run_id?: string | null; status: string; created_at: string; completed_at?: string | null; feedback?: MessageFeedback | null };
