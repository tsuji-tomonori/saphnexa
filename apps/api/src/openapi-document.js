// Generated by tools/generate-api-openapi-runtime-mirror.js from apps/api/src/openapi-document.ts. Do not edit by hand.
...
function tag(route) {
    if (route.viewerPath.startsWith("/auth/"))
        return "auth";
    if (route.viewerPath.startsWith("/api/admin/"))
        return "admin";
    if (route.viewerPath.includes("chat-sessions"))
        return "chat";
    if (route.viewerPath.includes("favorites"))
        return "favorites";
    return "system";
}
