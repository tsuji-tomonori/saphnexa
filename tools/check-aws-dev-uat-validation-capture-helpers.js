...
const helpers = [
  {
    ...
    validEnv: {
      ...
      SAPHNEXA_ALLURE_RUN_URL: "https://reports.uat.saphnexa.awsapps.com/admin/test-reports/allure/runs/run-20260528/",
      SAPHNEXA_CLOUDFRONT_ACCESS_LOG_S3_URI: "s3://saphnexa-uat-logs/cloudfront/run-20260528/",
      SAPHNEXA_E2E_SCENARIOS_JSON: JSON.stringify([
  ...
  },
  {
    ...
    requiredEnv: "SAPHNEXA_PERF_LOAD_PROFILE",
    validEnv: {
      SAPHNEXA_PERF_LOAD_PROFILE: "50 dau / 10 questions per user per day",
      ...
      SAPHNEXA_PERF_REPORT_URL: "https://reports.uat.saphnexa.awsapps.com/admin/evaluation-reports/performance/run-20260528/",
      SAPHNEXA_CLOUDWATCH_DASHBOARD_URL: "https://console.aws.amazon.com/cloudwatch/home?region=ap-northeast-1#dashboards:name=saphnexa-uat"
    },
  ...
  },
  {
    ...
    validEnv: {
      ...
      SAPHNEXA_RAG_BEDROCK_EVALUATION_JOB_ARN: `arn:aws:bedrock:ap-northeast-1:${["123456", "789012"].join("")}:evaluation-job/rag-eval-run-20260528`,
