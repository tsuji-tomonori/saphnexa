...
- [ ] final manifest の artifact URL が CloudFormation inventory の CloudFront distribution / admin artifacts bucket と無関係な場合、`acceptance:final-candidate:fixture:check` が失敗として検出する。
- [ ] CloudFormation inventory と整合する ready fixture は引き続き ready になる。
