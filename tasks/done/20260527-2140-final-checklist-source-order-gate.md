...
- [x] final checklist の AC ID 順序が source catalog と異なる場合、`acceptance:final-candidate:fixture:check` が失敗として検出する。
- [x] final checklist に重複 ID が含まれる場合、`acceptance:final-candidate:fixture:check` が失敗として検出する。
...
- 実装 commit: `34e0878` `✅ test: final checklist source order検査を追加`
- 作業レポート: `reports/working/20260527-2142-final-checklist-source-order-gate.md`
- PR 受け入れ条件確認コメント: https://github.com/tsuji-tomonori/saphnexa/pull/1#issuecomment-4554613218
- PR セルフレビューコメント: https://github.com/tsuji-tomonori/saphnexa/pull/1#issuecomment-4554614984
...
- `pre-commit run --files reports/working/20260527-2142-final-checklist-source-order-gate.md`: pass
