...
- [x] final candidate verifier が `docs_site.latest_url` の latest path を検査する。
- [x] final candidate verifier が `docs_site.version_url` の `versions/v0.16` path を検査する。
- [x] 誤った docs URL fixture が `manifest.docs_site.version_url_design_version` を検出する。
- [x] 関連 acceptance / docs / evidence / verify checks が pass する。
...
- 受け入れ条件確認: https://github.com/tsuji-tomonori/saphnexa/pull/1#issuecomment-4553873303
- セルフレビュー: https://github.com/tsuji-tomonori/saphnexa/pull/1#issuecomment-4553875861
...
- `npm run verify`: pass
- `git diff --check`: pass
- `pre-commit run --files tools/final-evidence-candidate.js tools/check-final-evidence-candidate-fixtures.js tasks/do/20260527-1950-final-docs-site-version-url-gate.md reports/working/20260527-1952-final-docs-site-version-url-gate.md`: pass
